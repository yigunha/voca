 ...
 * @returns {string}
 */
export function get_current_layer() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.get_current_layer();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
/**
 * @param {string} student_json
 * @param {string} teacher_json
 * @param {string} markings_json
 * @param {number} cols
 */
export function load_full_data_rs(student_json, teacher_json, markings_json, cols) {
    const ptr0 = passStringToWasm0(student_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(teacher_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(markings_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.load_full_data_rs(ptr0, len0, ptr1, len1, ptr2, len2, cols);
    if (ret[1]) {
 ...
 * @param {number} cols
 */
export function render_paper_rs(rows, cols) {
    const ret = wasm.render_paper_rs(rows, cols);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {boolean} hide
 */
export function toggle_empty_rows_rs(hide) {
    const ret = wasm.toggle_empty_rows_rs(hide);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {number} cols
 */
export function fill_grid_content(text, layer, cols) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(layer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.fill_grid_content(ptr0, len0, ptr1, len1, cols);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @returns {string}
 */
export function read_grid_content(rows, cols) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.read_grid_content(rows, cols);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @param {string} text
 */
export function update_cell_content(idx, text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.update_cell_content(idx, ptr0, len0);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {number} idx
 */
export function clear_cell_content(idx) {
    const ret = wasm.clear_cell_content(idx);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @returns {string}
 */
export function get_cell_content_rs(idx) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.get_cell_content_rs(idx);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @param {string} text
 */
export function set_cell_temp(idx, text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.set_cell_temp(idx, ptr0, len0);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {number} idx
 */
export function update_active_cell_rs(idx) {
    const ret = wasm.update_active_cell_rs(idx);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

export function clear_active_cell_rs() {
    const ret = wasm.clear_active_cell_rs();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {number} cols
 */
export function draw_markings_rs(markings_json, cols) {
    const ptr0 = passStringToWasm0(markings_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.draw_markings_rs(ptr0, len0, cols);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

export function clear_markings_rs() {
    const ret = wasm.clear_markings_rs();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {string} mode
 */
export function set_cell_mode(mode) {
    const ptr0 = passStringToWasm0(mode, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.set_cell_mode(ptr0, len0);
}
 ...
 * @param {number} cols
 */
export function init_input_state(rows, cols) {
    wasm.init_input_state(rows, cols);
}

/**
 * @param {number} idx
 */
export function set_cursor_pos(idx) {
    wasm.set_cursor_pos(idx);
}

/**
 * @param {string} text
 */
export function paste_external_text(text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.paste_external_text(ptr0, len0);
}

/**
 * @param {string} system_text
 */
export function handle_paste_flow(system_text) {
    const ptr0 = passStringToWasm0(system_text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.handle_paste_flow(ptr0, len0);
}

/**
 * @param {string} text
 */
export function paste_text_at_cursor(text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.handle_paste_flow(ptr0, len0);
}
 ...
 * @param {string} data
 */
export function handle_input_event(data) {
    const ptr0 = passStringToWasm0(data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.handle_input_event(ptr0, len0);
}

export function handle_composition_start() {
    wasm.handle_composition_start();
}

/**
 * @param {string} data
 */
export function handle_composition_update(data) {
    const ptr0 = passStringToWasm0(data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.handle_composition_update(ptr0, len0);
}

/**
 * @param {string} data
 */
export function handle_composition_end(data) {
    const ptr0 = passStringToWasm0(data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.handle_composition_end(ptr0, len0);
}
 ...
 */
export function handle_cell_mousedown(idx, shift_key) {
    wasm.handle_cell_mousedown(idx, shift_key);
}

/**
 * @param {number} idx
 */
export function handle_cell_mouseenter(idx) {
    wasm.handle_cell_mouseenter(idx);
}

export function handle_global_mouseup() {
    wasm.handle_global_mouseup();
}
...
export function delete_selected_cells() {
    wasm.delete_selected_cells();
}

export function force_stop_composition() {
 ...
 * @returns {Promise<any>}
 */
export function login_student(student_name, _class, password) {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.login_student(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret;
}
...
export function logout_student() {
    wasm.logout_student();
}
 ...
 * @returns {Promise<any>}
 */
export function fetch_my_manuscripts() {
    const ret = wasm.fetch_my_manuscripts();
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function save_student_content(id_f64, content) {
    const ptr0 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.save_student_content(id_f64, ptr0, len0);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function create_new_manuscript(title, cols) {
    const ptr0 = passStringToWasm0(title, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.create_new_manuscript(ptr0, len0, cols);
    return ret;
}

function wasm_bindgen__convert__closures_____invoke__ha773d59f2f8084c9(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__ha773d59f2f8084c9(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h20e9c373f166664a(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h20e9c373f166664a(arg0, arg1, arg2, arg3);
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_instanceof_HtmlDocument_77e5391fcfef3770 = function(arg0) {
        let result;
        try {
    ...
    imports.wbg.__wbg_new_3c3d849046688a66 = function(arg0, arg1) {
        try {
            ...
            var cb0 = (arg0, arg1) => {
                ...
                state0.a = 0;
                try {
                    return wasm_bindgen__convert__closures_____invoke__h20e9c373f166664a(a, state0.b, arg0, arg1);
                } finally {
                    state0.a = a;
                }
            };
    ...
    imports.wbg.__wbg_setTime_e03c569764901354 = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_toUTCString_514573d0c48f176b = function(arg0) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wongoji_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
