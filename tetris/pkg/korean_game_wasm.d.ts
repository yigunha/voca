/* tslint:disable */
/* eslint-disable */
export function parse_answer_rs(answer: string): any;
export function generate_initial_sequence(correct_blocks_json: string, fake_blocks_json: string, seed: number): string;
export function generate_next_block(user_answer: string, correct_answer: string, already_sent_json: string, all_correct_blocks_json: string, fake_blocks_json: string, used_fakes_json: string, seed: number): string;
...
export class GameEngine {
  ...
  free(): void;
  [Symbol.dispose](): void;
  static new(rows: number, cols: number): GameEngine;
  clear_grid(): void;
  check_collision(row: number, lane: number, block_len: number): boolean;
  stack_block(row: number, lane: number, block_len: number, block_id: number): void;
  get_cell_id(row: number, col: number): number;
  remove_block(block_id: number): void;
}
...
export interface InitOutput {
  ...
  readonly parse_answer_rs: (a: number, b: number) => [number, number, number];
  readonly __wbg_gameengine_free: (a: number, b: number) => void;
  readonly gameengine_new: (a: number, b: number) => number;
  readonly gameengine_clear_grid: (a: number) => void;
  readonly gameengine_check_collision: (a: number, b: number, c: number, d: number) => number;
  readonly gameengine_stack_block: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly gameengine_get_cell_id: (a: number, b: number, c: number) => number;
  readonly gameengine_remove_block: (a: number, b: number) => void;
  readonly generate_initial_sequence: (a: number, b: number, c: number, d: number, e: number) => [number, number];
  readonly generate_next_block: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => [number, number];
